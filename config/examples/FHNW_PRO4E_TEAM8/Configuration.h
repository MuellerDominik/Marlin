 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 1 // ESP32 <-> STM32
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 2 // USB (FTDI) <-> STM32
 ...
 */
#define BAUDRATE 250000 // maybe 115200 or even 1000000
...
#define X_BED_SIZE 220 // Ender 3
#define Y_BED_SIZE 220 // Ender 3
...
#define FAN_SOFT_PWM // has to be enabled due to the Fan
